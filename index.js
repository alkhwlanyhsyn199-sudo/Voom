...
<script>function uploadVoom(){const i=document.createElement("input");i.type="file";i.accept="video/*";i.onchange=()=>{if(i.files[0])alert("تم اختيار الفيديو: "+i.files[0].name)};i.click()}</script>
