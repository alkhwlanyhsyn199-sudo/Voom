...
<div class="channel">Voom Gaming</div><br><input placeholder="اكتب تعليقك..." style="padding:10px;border:1px solid #ddd;border-radius:8px"><button>💬 تعليق</button><button>👍 إعجاب</button> <button>🔖 حفظ</button><button onclick="creatorDashboard()">📊 لوحة التحكم</button>
</div>
